...
Results: This project (which is actually much larger in scope than all that is discussed here,) with a little work and help from my mentor and the curriculum ended up fully-functional, as can be seen in various screenshots below: (NEED TO WRITE MORE)

![bloccit_screenshot_6](/img/bloccit_6.png){:class="img-responsive"}
![bloccit_screenshot_5](/img/bloccit_5.png){:class="img-responsive"}

Don't mind the gibberish, posts were randomly generated by code in the database for testing.
